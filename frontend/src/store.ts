...
function seed(): DB {
  ...
  d.users = [
    { id: 1, employee_id: 'E001', name: 'Rahim Uddin', email: 'rahim@anwargroup.com', designation: 'Group CEO', role: 'group_executive', company_id: 1, function_id: 1, reports_to: undefined, is_active: true },
    { id: 2, employee_id: 'E002', name: 'Karim Ahmed', email: 'karim@anwarcement.com', designation: 'Business Head', role: 'business_head', company_id: 2, function_id: 1, reports_to: 1, is_active: true },
    { id: 3, employee_id: 'E003', name: 'Shahin Alam', email: 'shahin@anwargroup.com', designation: 'CFO', role: 'functional_head', company_id: 1, function_id: 2, reports_to: 1, is_active: true },
    { id: 4, employee_id: 'E004', name: 'Farida Khan', email: 'farida@anwargroup.com', designation: 'PMO Lead', role: 'pmo', company_id: 1, function_id: 4, reports_to: 1, is_active: true },
    { id: 5, employee_id: 'E005', name: 'Tanvir Hasan', email: 'tanvir@anwarcement.com', designation: 'Project Manager', role: 'pm', company_id: 2, function_id: 1, reports_to: 2, is_active: true },
    { id: 6, employee_id: 'E006', name: 'Nusrat Jahan', email: 'nusrat@anwarcement.com', designation: 'Engineer', role: 'employee', company_id: 2, function_id: 1, reports_to: 5, is_active: true },
    { id: 7, employee_id: 'E007', name: 'Imran Kabir', email: 'imran@anwarcement.com', designation: 'Sales Lead', role: 'team_lead', company_id: 2, function_id: 3, reports_to: 2, is_active: true },
    { id: 8, employee_id: 'E008', name: 'Sadia Rahman', email: 'sadia@anwargroup.com', designation: 'Auditor', role: 'auditor', company_id: 1, function_id: 2, reports_to: 1, is_active: true },
    { id: 9, employee_id: 'E009', name: 'System Administrator', email: 'admin@anwargroup.com', designation: 'Platform Admin', role: 'admin', company_id: 1, function_id: 4, reports_to: 1, is_active: true },
    { id: 10, employee_id: 'E010', name: 'Ayesha Siddiqua', email: 'ayesha@anwarcement.com', designation: 'Plant Engineer', role: 'employee', company_id: 2, function_id: 1, reports_to: 11, is_active: true },
    { id: 11, employee_id: 'E011', name: 'Mahmudul Hasan', email: 'mahmud@anwarcement.com', designation: 'Maintenance Lead', role: 'team_lead', company_id: 2, function_id: 1, reports_to: 5, is_active: true },
    { id: 12, employee_id: 'E012', name: 'Rashida Akter', email: 'rashida@anwargroup.com', designation: 'Financial Analyst', role: 'employee', company_id: 1, function_id: 2, reports_to: 3, is_active: true },
    { id: 13, employee_id: 'E013', name: 'Shafiqul Islam', email: 'shafiqul@anwargroup.com', designation: 'IT Manager', role: 'pm', company_id: 1, function_id: 4, reports_to: 3, is_active: true },
    { id: 14, employee_id: 'E014', name: 'Nasrin Sultana', email: 'nasrin@anwargroup.com', designation: 'HRBP', role: 'employee', company_id: 1, function_id: 6, reports_to: 3, is_active: true },
    { id: 15, employee_id: 'E015', name: 'Kazi Rafiq', email: 'rafiq@anwarcementsheet.com', designation: 'Supply Chain Head', role: 'functional_head', company_id: 3, function_id: 5, reports_to: 1, is_active: true },
    { id: 16, employee_id: 'E016', name: 'Sumaiya Akter', email: 'sumaiya@anwarcement.com', designation: 'Sales Executive', role: 'employee', company_id: 2, function_id: 3, reports_to: 7, is_active: true },
    { id: 17, employee_id: 'E017', name: 'Arif Chowdhury', email: 'arif@aonepolymer.com', designation: 'Production Manager', role: 'pm', company_id: 4, function_id: 9, reports_to: 1, is_active: true },
    { id: 18, employee_id: 'E018', name: 'Farzana Haque', email: 'farzana@anwarsteel.com', designation: 'QA Head', role: 'functional_head', company_id: 5, function_id: 8, reports_to: 1, is_active: true },
    { id: 19, employee_id: 'E019', name: 'Rafiqul Islam', email: 'rafiqul@anwarcementsheet.com', designation: 'Operations Lead', role: 'team_lead', company_id: 3, function_id: 1, reports_to: 15, is_active: true },
    { id: 20, employee_id: 'E020', name: 'Nadia Rahman', email: 'nadia@aonepolymer.com', designation: 'Procurement Officer', role: 'employee', company_id: 4, function_id: 7, reports_to: 17, is_active: true },
  ]
  d.listOptions = [
...
export const store = {
  ...
  // Order: reviewer → accountable → responsible's manager (reports_to chain) → privileged user
  approverFor: (task: Task) => {
    ...
    while (current && !seen.has(current.id)) {
      seen.add(current.id)
      const manager = current.reports_to ? db.users.find((u) => u.id === current!.reports_to) : undefined
      if (!manager) break
  ...
  reportingChain: (userId: number): User[] => {
    ...
    while (current && !seen.has(current.id)) {
      seen.add(current.id)
      chain.push(current)
      current = current.reports_to ? db.users.find((u) => u.id === current!.reports_to) : undefined
    }
    return chain
  },
